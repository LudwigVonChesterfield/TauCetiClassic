...
`"forced_items"` указывает какие предметы будут выданы игроку, ещё до выдачи профессии.

`"forced_people_traits"` указывает какие трейты будут выданы человеку-игроку, что заспавнился на этой станции(или присоединился после начала раунда).
