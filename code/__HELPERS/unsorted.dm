...
/proc/can_operate(mob/living/carbon/M)
	...
	(M.buckled || M.lying || M.weakened || M.IsStun() || M.paralysis || M.stat)) && prob(95) || 	\
	(locate(/obj/structure/stool/bed/roller, M.loc) && 	\
	(M.buckled || M.lying || M.weakened || M.IsStun() || M.paralysis || M.stat)) && prob(75) || 	\
	(locate(/obj/structure/table, M.loc) && 	\
	(M.lying || M.weakened || M.IsStun() || M.paralysis || M.stat) && prob(66))
