...
/proc/generate_asteroid_mapfile(size_x, size_y)
	var/map = "\
		...
		\"[FLOORTURF]\" = (/turf/simulated/floor/plating/airless/asteroid,/area/asteroid/mine/biome/asteroids/unexplored)\n\
		\"[CAVETURF]\" = (/turf/simulated/mineral/random/caves,/area/asteroid/mine/biome/asteroids/unexplored)\n\
		\"[RESCAVETURF]\" = (/turf/simulated/mineral/random/high_chance,/area/asteroid/mine/biome/asteroids/unexplored)\n\
		\"[MOBTURF]\" = (/mob/living/simple_animal/hostile/asteroid/goliath,/turf/simulated/floor/plating/airless/asteroid,/area/asteroid/mine/biome/asteroids/unexplored)\n\
		\"[ARTTURF]\" = (/obj/machinery/artifact,/turf/simulated/floor/plating/airless/asteroid,/area/asteroid/mine/biome/asteroids/unexplored)\n\
		(1,1,1) = {\""
