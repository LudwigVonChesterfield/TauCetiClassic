/datum/destruction_decal/crack
	name = "crack"
	dest_type = DEST_BLUNT
	pos_sizes = list("0" = 8.0)

/datum/destruction_decal/crack/on_creation(atom/movable/perp, datum/reagents/R, datum/destruction_measure/DM)
