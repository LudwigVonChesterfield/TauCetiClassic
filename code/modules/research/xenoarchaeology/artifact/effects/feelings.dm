...
/datum/artifact_effect/feelings/bad/send_drastic_message(mob/receiver)
	...
	if(isliving(receiver))
		...
		L.add_karmatic_factor("drastic_effect_bad", /datum/karmatic_factor/artifact_effect_bad_major)
...
/datum/artifact_effect/feelings/bad/send_minor_message(mob/receiver)
	...
	if(isliving(receiver))
		var/mob/living/L = receiver
		L.add_karmatic_factor("minor_effect_bad", /datum/karmatic_factor/artifact_effect_bad_minor)
...
/datum/artifact_effect/feelings/good/send_drastic_message(mob/receiver)
	...
	if(isliving(receiver))
		var/mob/living/L = receiver
		L.add_karmatic_factor("drastic_effect_good", /datum/karmatic_factor/artifact_effect_good_major)
...
/datum/artifact_effect/feelings/good/send_minor_message(mob/receiver)
	...
	if(isliving(receiver))
		var/mob/living/L = receiver
		L.add_karmatic_factor("minor_effect_good", /datum/karmatic_factor/artifact_effect_good_minor)
