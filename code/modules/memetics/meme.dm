...
/datum/meme
	...
	// A message displayed to player when they prepare to say this meme.
	var/say_txt
	// A message displayed to player when they prepare to write this meme down.
	var/write_txt
...
// How this meme warps spoken text.
/datum/meme/proc/warp_spoken_text(datum/source, mob/speaker, text)
	return text

// How this meme warps taken action.
/datum/meme/proc/warp_taken_action(datum/source, mob/speaker, action)
	return action

// How this meme warps perceived text.
/datum/meme/proc/warp_perceived_text(datum/source, mob/perceiver, text)
	return text

// How this meme warps perceived visual clues.
/datum/meme/proc/warp_perceived_visual(datum/source, mob/perceiver, visual)
	return visual
...
/datum/meme/proc/on_read(datum/source, mob/reader, text)
	...
	var/new_text = warp_perceived_text(source, reader, text)
	if(text != new_text)
		. = new_text
...
/mob/proc/can_read(atom/source)
	return FALSE

/mob/dead/observer/can_read(atom/source)
	return TRUE

/mob/living/carbon/human/can_read(atom/source)
	return TRUE

/mob/living/silicon/can_read(atom/source)
	return TRUE
