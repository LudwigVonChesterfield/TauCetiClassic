...
/datum/ritual_step/proc/on_success()
	...
	if(ritual.current_step == ritual.ritual_steps.len)
		world.log << "we done for"
		ritual.accomplish()
	else
		world.log << "we din dun we [ritual.current_step]"
		ritual.current_step++
...
/datum/ritual_step/sacrifice
	...
	var/damage_to_deal = 0          // Damage needed to deal to accomplish the ritual.
